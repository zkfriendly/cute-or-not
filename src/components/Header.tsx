...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-10 bg-gray-900 shadow-md border-b border-gray-800">
            <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                ...
                <nav className="hidden md:flex space-x-6">
                    ...
                    <Link href="/trending" className="text-gray-300 hover:text-pink-400 transition-colors">
                        Trending
                    </Link>
                    <Link href="/compare/rankings" className="text-gray-300 hover:text-pink-400 transition-colors">
                        Rankings
                    </Link>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute right-0 mt-2 w-48 bg-gray-800 rounded-md shadow-lg py-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                            ...
                            <Link href="/portfolio" className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">
                                Portfolio
                            </Link>
